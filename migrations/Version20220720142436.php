 ...
 */
final class Version20220720142436 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE contact (id INT AUTO_INCREMENT NOT NULL, housekeeping_id INT DEFAULT NULL, personal_assistance_service_id INT DEFAULT NULL, administrative_department_id INT DEFAULT NULL, firstname VARCHAR(50) NOT NULL, lastname VARCHAR(50) NOT NULL, maiden_name VARCHAR(50) DEFAULT NULL, mail VARCHAR(100) DEFAULT NULL, adress VARCHAR(255) NOT NULL, zip_code INT NOT NULL, city VARCHAR(100) NOT NULL, phone_number INT NOT NULL, content VARCHAR(255) DEFAULT NULL, preferency TINYINT(1) NOT NULL, created_at DATE NOT NULL, UNIQUE INDEX UNIQ_4C62E6382839160B (housekeeping_id), UNIQUE INDEX UNIQ_4C62E638F80D8CE9 (personal_assistance_service_id), UNIQUE INDEX UNIQ_4C62E6387E4350FB (administrative_department_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE frequency (id INT AUTO_INCREMENT NOT NULL, housekeeping_id INT NOT NULL, type VARCHAR(20) DEFAULT NULL, INDEX IDX_267FB8132839160B (housekeeping_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE intervention (id INT AUTO_INCREMENT NOT NULL, personal_assistance_service_id INT NOT NULL, moment VARCHAR(50) NOT NULL, INDEX IDX_D11814ABF80D8CE9 (personal_assistance_service_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
