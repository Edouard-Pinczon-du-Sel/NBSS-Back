 ...
 */
final class Version20220720140426 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE intervention (id INT AUTO_INCREMENT NOT NULL, babysitting_service_id INT NOT NULL, personal_assistance_service_id INT NOT NULL, moment VARCHAR(50) NOT NULL, INDEX IDX_D11814ABA2128973 (babysitting_service_id), INDEX IDX_D11814ABF80D8CE9 (personal_assistance_service_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
